...
* [GridAdapter.java](https://github.com/vantrinh7/Bond/blob/master/app/src/main/java/com/example/demouser/bond/GridAdapter.java) is an adapter that helps generate a calendar grid view. It adds and displays current date and events on the calendar.
